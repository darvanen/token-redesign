...
use Drupal\Core\Token\TokenContextMatcher;
 ...
 *
 * @see \Drupal\Core\Token\TokenContextMatcher
...
class TokenContextMatcherTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    $this->matcher = $this->container->get('token.context_matcher');
  }
  ...
  public function testTaxonomyTermAliasIsMapped(): void {
    $mapper = $this->container->get('token.entity_type_mapper');
