 ...
 *
 * @see \Drupal\Core\Token\TokenResolutionEngine::translateResult()
 */
#[CoversClass(\Drupal\Core\Token\TokenResolutionEngine::class)]
#[Group('Token')]
...
class TokenTranslationTest extends TokenReplaceKernelTestBase {
  ...
  public function testRendererTranslatesEntityLabel(): void {
    $renderer = $this->container->get('token.renderer');
