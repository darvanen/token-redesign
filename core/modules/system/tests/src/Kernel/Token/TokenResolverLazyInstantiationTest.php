 ...
 * @see \Drupal\Core\Token\Discovery\AttributedTokenDiscovery
 */
#[CoversClass(\Drupal\Core\Token\Discovery\AttributedTokenDiscovery::class)]
#[Group('Token')]
...
class TokenResolverLazyInstantiationTest extends KernelTestBase {
   ...
   * {@inheritdoc}
   */
  protected static $modules = ['system', 'token_context_test'];
