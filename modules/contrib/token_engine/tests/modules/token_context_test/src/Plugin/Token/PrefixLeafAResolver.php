...
/**
 * First leaf token off memo_probe_prefixed, used to prove memo effectiveness.
 *
 * Chain: [memo_probe:prefix:leaf_a]
 */
#[Token(
  name: 'leaf_a',
  input_type: 'memo_probe_prefixed',
  output_type: 'string',
  label: new TranslatableMarkup('Prefix leaf A'),
)]
final class PrefixLeafAResolver implements TokenResolverInterface {

  /**
   * {@inheritdoc}
   */
  public function resolve(mixed $input, array $arguments, TokenResolutionContext $context): TokenResult {
    return TokenResult::fromValue('leaf_a_value');
  }
