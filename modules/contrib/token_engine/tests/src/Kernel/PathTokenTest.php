 ...
 *
 * @see \Drupal\token_engine\PathToken
...
class PathTokenTest extends TokenReplaceKernelTestBase {
  ...
  public function testPathTokenInstantiatesWithoutFactory(): void {
    $resolver = $this->container->get('plugin.manager.token_engine_resolver')->createInstance('entity:node:title_via_path');
  ...
  public function testPathTokenResolvesDeclaredPath(): void {
    ...
    $result = $this->container->get('token_engine.resolution_engine')
