 ...
 *    injected via the `token_engine.generic_resolver` tag.
 *
 * @internal
...
final class AttributedTokenDiscovery implements TokenDiscoveryInterface {
   ...
   *
   * @var array<class-string, \Drupal\token_engine\TokenResolverInterface>
   */
  ...
  /**
   * @param \Drupal\token_engine\TokenResolverManager $manager
   ...
   *   `token_engine.generic_resolver` tag.
   */
   ...
   *
   * @return \Drupal\token_engine\TokenResolverInterface|null
