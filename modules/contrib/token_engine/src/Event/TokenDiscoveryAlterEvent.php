...
namespace Drupal\token_engine\Event;
...
final class TokenDiscoveryAlterEvent extends Event {
  ...
  /**
   * @param array<string, array<string, \Drupal\token_engine\TokenDefinition>> $definitions
   ...
   *
   * @param \Drupal\token_engine\TokenDefinition $definition
