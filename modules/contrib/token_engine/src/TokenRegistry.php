...
use Drupal\token_engine\Discovery\TokenDiscoveryInterface;
...
final class TokenRegistry implements TokenRegistryInterface {
   ...
   *
   * @var array<string, array<string, \Drupal\token_engine\TokenDefinition>>
   */
   ...
   *
   * @var \Drupal\token_engine\Discovery\TokenDiscoveryInterface[]
   */
   ...
   * @param iterable<\Drupal\token_engine\Discovery\TokenDiscoveryInterface> $autoDiscoverySources
   *   Auto-discovery sources (lowest precedence), collected via the
   *   `token_engine.discovery.auto` tag.
   * @param iterable<\Drupal\token_engine\Discovery\TokenDiscoveryInterface> $explicitDiscoverySources
   *   Explicit discovery sources (override auto-discovery), collected via the
   *   `token_engine.discovery` tag.
   ...
   *
   * @return \Drupal\token_engine\Discovery\TokenDiscoveryInterface[]
